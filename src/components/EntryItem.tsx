      ...
      {editing ? (
        ...
        >
          ...
          <input
            ...
            onKeyDown={(e) => e.key === "Escape" && cancelEditing()}
            aria-label="Data"
            className="w-[9.5rem] shrink-0 rounded-xl border-2 border-pink-200 bg-white px-2 py-2 text-center text-sm text-ink outline-none transition-colors focus:border-pink-400"
          />
          <button
            type="submit"
